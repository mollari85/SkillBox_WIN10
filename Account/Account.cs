...
namespace Accountlib
{
    public abstract class Account:INotifyPropertyChanged, IComparable
    {
        ...
        public static event EventHandler? eventWithdrawNotify;
        public static event EventHandler? eventRefillNotify;
        public static event EventHandler? eventTransferInNotify;
        public static event EventHandler? eventTransferOutNotify;
        /// <summary>
